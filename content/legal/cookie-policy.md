...
Used to distinguish individual users by means of designation of a randomly generated number as client identifier, which allows calculation of visits and sessions useiwantthat.com   
...
Name:   
\_gat\#   
Enables Google Analytics regulate the rate of requests. It is a HTTP cookie type that lasts for a session on useiwantthat.com  
Google Analytics View Service Privacy Policy \< https://policies.google.com/privacy\> United States 
...
Firefox \< https://support.mozilla.org/en-US/kb/enhanced-tracking-protection-firefox desktop?redirectslug=enable-and-disable-cookies-website   
preferences\&redirectlocale=en-US\> 
