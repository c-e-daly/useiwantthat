...
* Referral data. Contact details of friends or contacts that you refer to us or that refer you, such as when you invite them or are invited by them to use the Service. You should not share your friends’ or contacts’ information with us unless you have permission to do so.
...
Service delivery. We use your personal data to register your Service account, to manage and administer your Service account, provide the Service and to communicate with you about our Service (including support and administrative messages that we may send via email, chat features in the Service or other channels).
...
Affiliates. We may share all categories of personal data with other corporate affiliates that we control, are controlled by, or with which we are under common control, for purposes consistent with this Privacy Notice.
...
Other users and the public. Other users of our blogs and forums to which you post content visible to them, such as useiwantthat.com, parts of which are publicly accessible.
...
Request deletion. You may request deletion of your information by contacting us with your request.
...
If you have questions or concerns about this Privacy Notice or our practices, please contact us at compliance@useiwantthat.com.
...
| :---- | :---- |
| Identifiers Contact data Account data Communications data Device data Referral data | Affiliates Service providers Payment processors Authentication services Other users and the public |
| California Customer Records (as defined in California Civil Code §1798.80) Contact data Account data Transaction data Communications data Referral data | Affiliates Service providers Payment processors Other users and the public |
| Commercial information Device data Usage data Transaction data | Affiliates Service providers Payment processors Authentication services |
| Internet or Network Information Device data Usage data | Affiliates Service providers |
| Geolocation data Usage data Precise geolocation data | Affiliates Service providers |
| Audio, Electronic, Visual, Thermal, Olfactory, or Similar Information Security data Communications data Device data Usage data | Affiliates Service providers |
| Professional or Employment Information Contact data Account data | Affiliates Service providers |
| Education Information Contact data Account data | Affiliates Service providers |
| Sensitive personal information Account data (Service account or third party service passwords) Transaction data (payment card information) Precise geolocation data | Affiliates Service providers Payment processors Authentication services |
| Inferences May be derived from all the above | Affiliates Service providers |
...
| :---- | :---- |
| **Types of personal data processed** | **Legal basis** |
| Contact data Account data Payment data Communication data Device data Usage data Precise geolocation data Referral data | Contractual Necessity. If we have not entered a contract with you, we process your personal data based our Legitimate Interests (in providing the Services you access or request) |

| Processing Purpose: Business operations |  |
| :---- | :---- |
| **Types of personal data processed** | **Legal basis** |
| Contact data Account data Communication data Device data Usage data Precise geolocation data Referral data | Contractual Necessity. If we have not entered a contract with you, we process your personal data based our Legitimate Interests (in operating, providing, and improving our business) |

| Processing Purpose: Research and development |  |
| :---- | :---- |
| **Types of personal data processed** | **Legal basis** |
| Contact data Account data Communication data Device data Usage data Precise geolocation data Referral data | Our Legitimate Interests (in analyzing and improving our Services and our business). |

| Processing Purpose: Marketing |  |
| :---- | :---- |
| **Types of personal data processed** | **Legal basis** |
| Contact data Account data Communication data Device data Usage data Precise geolocation data Referral data | Our Legitimate Interests (in promoting our products and services through marketing communications). We are required to rely on your Consent to the transmission of direct marketing emails in line with our obligations under applicable laws implementing the ePrivacy Directive, as explained above. |

| Processing Purpose: Targeted advertising |  |
| :---- | :---- |
| **Types of personal data processed** | **Legal basis** |
| Contact data Device data Usage data | Our Legitimate Interests (in promoting our products and services through targeted advertisements). |

| Processing Purpose: Sharing your personal data as described in this Privacy Notice |  |
| :---- | :---- |
| **Types of personal data processed** | **Legal basis** |
| Contact data Account data Communication data Referral data | We use the original legal basis relied upon if the relevant further use is compatible with the initial purpose for which the personal data was collected. Otherwise, we rely on your Consent. |

| Processing Purpose: Compliance and Protection |  |
| :---- | :---- |
| **Types of personal data processed** | **Legal basis** |
| Security data Precise geolocation data All other data relevant in the circumstances | Compliance with Law (where processing is necessary to comply with our legal obligations). Otherwise, we rely on our Legitimate Interests (in protecting our, your or others’ rights, privacy, safety or property). |

| Processing Purpose: Any of the above purposes facilitated by cookies, similar technologies or precise geolocation data |  |
| :---- | :---- |
| **Types of personal data processed** | **Legal basis** |
| Device data Usage data Precise geolocation data | Our Legitimate Interests (in operating, providing, and improving our business and promoting our products and services). We are required to rely on your consent to the use of cookies or similar tracking technologies in line with our obligations under applicable laws implementing the ePrivacy Directive, as explained above. |
