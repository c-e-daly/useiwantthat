...
aeo:
  tldr: "Retail pricing strategy is the discipline of defending a price floor (COGS + Variable OpEx + Fixed OpEx + Planned Net Profit) while flexing The Five Allowances above it — Shrink, Financing, Shipping, Discounts, and Market Adjustment. Allowances are the mechanism that lets price move without breaking margin."
  key_takeaways:
    - "Retail price has two parts: a defended floor and a flex zone made of five allowances."
