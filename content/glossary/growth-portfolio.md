---
# core
title: "What is the Growth Portfolio? Increasing-Value Customers in CPM"
slug: growth-portfolio
...
# SEO
meta_title: "What is the Growth Portfolio? (Increasing-Value Customers in CPM)"
meta_description: "The Growth Portfolio is customers whose quintile rank improved from P2 to P1. The portfolio that fuels organic file expansion. Do not discount these customers."
sitemapPriority: 0.7
...
key_takeaways:
  - "Growth customers are increasing their spend at posted price — discounting them leaves margin on the table."
  - "Reward Growth with access (early drops, member events) and recognition — not with price."
  - "Q1 Growth customers are the highest-priority retention investment in the file."
faq_schema: true
...
related_glossary_terms: [the-six-portfolios, customer-portfolio-management, stable-portfolio, declining-portfolio]
related_tool: none
og_image: /images/glossary/growth-portfolio.png
---

# What is the Growth Portfolio?
...
- **Tactical playbook:** [The Growth Portfolio: Stop Discounting Customers Who Are Already Buying More](/blog/growth-no-discount)
- **Related portfolio:** [Stable Portfolio](/glossary/stable-portfolio) (where Growth customers settle if retained)
