---
# core
title: "What is Gross Sales? Definition and Formula"
slug: gross-sales
...
# SEO
meta_title: "What is Gross Sales? (Definition for Ecommerce Operators)"
meta_description: "Gross Sales is the sum of item selling prices times units purchased, before any discounts or returns. The starting point of every sales calculation."
sitemapPriority: 0.7

# AEO
tldr: "Gross Sales is the sum of item selling prices multiplied by units purchased, before any discounts, returns, or cancellations. It represents the maximum revenue the business could have collected if every customer paid full price and kept every unit. Gross Sales is the starting point for the three-layer sales reporting that produces NOR Sales and Net Sales."
key_takeaways:
  - "Gross Sales is calculated before any reductions — no discounts, no returns, no cancellations."
  - "It is the maximum-revenue baseline, not the revenue the business actually collected."
  - "Used to calculate AUR (Average Unit Retail) — the average selling price across the file."
faq_schema: true
...
related_glossary_terms: [key-measures, nor-sales, net-sales, aur, discount-rate]
related_tool: none
og_image: /images/glossary/gross-sales.png
---
...
- **The next layer:** [NOR Sales](/glossary/nor-sales)
- **From the Customer Portfolios pillar:** [Customer Portfolio Management](/blog/category/customer-portfolios)
