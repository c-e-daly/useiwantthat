---
# core
title: "What is the Defected Portfolio? Lost Customers in CPM"
slug: defected-portfolio
...
# AEO
tldr: "The Defected Portfolio is the set of customers who purchased in P2 (13–24 months ago) but did not purchase in P1 (current 12 months). They shopped last year and have not this year. Defected is the hardest portfolio to recover, but the one that reveals the most about why customers leave. Prior-period quintile rank is preserved so operators can prioritize recovery investment by historical value."
key_takeaways:
  - "Defected customers shopped last year and have not this year — the file is losing them."
  - "Recovery spend should match the customer's prior quintile, not be applied flat across the portfolio."
  - "Q1 Defected — recently top-tier customers gone — justifies significantly higher recovery investment than Q5 Defected."
faq_schema: true
...
related_glossary_terms: [the-six-portfolios, customer-portfolio-management, declining-portfolio, reactivated-portfolio]
related_tool: none
og_image: /images/glossary/defected-portfolio.png
---

# What is the Defected Portfolio?
...
- **Tactical playbook:** [The Defected Portfolio: Recapture Spend Should Match Prior Quintile](/blog/defected-recapture-quintile)
- **Related portfolio:** [Reactivated Portfolio](/glossary/reactivated-portfolio) (Defected customers who eventually return)
