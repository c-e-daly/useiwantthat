---
# core
title: "What is the New Portfolio? First-Purchase Customers in CPM"
slug: new-portfolio
...
# SEO
meta_title: "What is the New Portfolio? (First-Purchase Buyers in CPM)"
meta_description: "The New Portfolio is the first of The Six Portfolios — customers with a first purchase in the current 12 months and no prior history."
sitemapPriority: 0.7

# AEO
tldr: "The New Portfolio is the set of customers whose first-ever purchase falls within the current 12-month period (P1) with no prior history in earlier periods. New is the entry point to the customer file and the portfolio whose second-order conversion rate determines whether the brand grows or churns. Each customer in the New Portfolio is quintiled by P1 net sales to separate high-value first-purchasers from low-value ones."
key_takeaways:
  - "New customers have no prior history — they are pure entry points to the file."
  - "The second-order conversion rate, not the first-order discount, is what defines New Portfolio health."
  - "Q1 New and Q5 New behave entirely differently and need different second-order strategies."
faq_schema: true
...
related_glossary_terms: [the-six-portfolios, customer-portfolio-management, reactivated-portfolio, growth-portfolio]
related_tool: none
og_image: /images/glossary/new-portfolio.png
---
...
1. **Separate Q1 New from Q5 New** in every marketing analysis and every offer campaign — they are not the same audience.
2. **Measure second-order conversion rate by quintile**, not in aggregate. Q1 New should convert at meaningfully higher rates than Q5 New; if they don't, the second-order program is misfiring on the high-value segment.
3. **Build the second-order campaign by quintile** — Q1 New gets clienteling-style outreach; Q5 New gets a clear value-exchange offer to test whether they're a real audience or a discount artifact.

## Related terms

- [The Six Portfolios](/glossary/the-six-portfolios)
- [Customer Portfolio Management](/glossary/customer-portfolio-management)
- [Reactivated Portfolio](/glossary/reactivated-portfolio)
...
- **Tactical playbook:** [The New Portfolio: How to Read First-Purchasers Before Their Second Order](/blog/new-portfolio-second-order)
- **Related concept:** [Repeat Rate](/glossary/repeat-rate) (the Customer Yield metric that measures New-to-Growth conversion)
