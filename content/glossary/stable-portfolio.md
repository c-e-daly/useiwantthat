---
# core
title: "What is the Stable Portfolio? The Base of the Customer File"
slug: stable-portfolio
...
related_glossary_terms: [the-six-portfolios, customer-portfolio-management, growth-portfolio, declining-portfolio]
related_tool: none
og_image: /images/glossary/stable-portfolio.png
---

# What is the Stable Portfolio?
...
1. **Measure Stable count and Stable Q1–Q2 share as a primary file-health metric.** If Stable shrinks while Declining grows, you have silent erosion in progress.
2. **Build loyalty and membership programs targeting the Stable Portfolio** — the switching cost is what keeps Stable stable. Discounts are not the right tool; benefits and access are.
3. **Set up an early-warning trigger for Stable-to-Declining migration.** When a Stable customer's recent activity suggests they're about to reclassify downward, intervene with retention outreach before the next AMT cycle confirms the move.
...
- **Tactical playbook:** [The Stable Portfolio: The Silent Erosion to Declining](/blog/stable-erosion)
- **Related portfolio:** [Declining Portfolio](/glossary/declining-portfolio) (where unsupported Stable customers drift)
