---
# core
title: "What is the Reactivated Portfolio? Win-Back Customers in CPM"
slug: reactivated-portfolio
...
# SEO
meta_title: "What is the Reactivated Portfolio? (Returning Customers in CPM)"
meta_description: "The Reactivated Portfolio is the set of customers who purchased in the current 12 months and 24–36 months ago — but not in between. The win-back portfolio."
sitemapPriority: 0.7

# AEO
tldr: "The Reactivated Portfolio is the set of customers with a purchase in P1 (current 12 months) and P3 (24–36 months ago) but no purchase in P2 (13–24 months). These are customers who went dark and came back on their own initiative. Reactivated is often the highest-margin recovery opportunity in the file because the customer self-selected to return."
key_takeaways:
  - "Reactivated customers chose to come back — they need recognition, not a discount."
  - "Discount-led win-backs train customers to wait for the next gap; recognition-led win-backs build loyalty."
  - "Reactivated is often the highest-margin portfolio per customer because reactivation costs less than acquisition."
faq_schema: true
...
related_glossary_terms: [the-six-portfolios, customer-portfolio-management, new-portfolio, defected-portfolio]
related_tool: none
og_image: /images/glossary/reactivated-portfolio.png
---

# What is the Reactivated Portfolio?
...
1. **Identify Reactivated customers separately from New** in your CRM and email platform — the welcome series for a Reactivated customer should look different from the one a New customer receives.
2. **Lead with recognition, not discount.** A "welcome back" message that references the customer's prior purchase outperforms a percentage-off offer in nearly every test.
3. **Measure Reactivated retention separately** — track how many Reactivated customers convert to Growth or Stable in the next period, versus how many drop back to Declining or Defected. This is the cleanest measure of whether your reactivation experience is working.

## Related terms

- [The Six Portfolios](/glossary/the-six-portfolios)
- [Customer Portfolio Management](/glossary/customer-portfolio-management)
- [New Portfolio](/glossary/new-portfolio)
- [Defected Portfolio](/glossary/defected-portfolio)
...
- **Tactical playbook:** [The Reactivated Portfolio: Why Win-Back Discounts Are the Wrong Offer](/blog/reactivated-no-discount)
- **Related portfolio:** [Defected Portfolio](/glossary/defected-portfolio) (the customers who have not yet reactivated)
