---
# core
title: "What is Return Rate? The Post-Purchase Leak Measure"
slug: return-rate
...
# SEO
meta_title: "What is Return Rate? (Ecommerce Returns Measure)"
meta_description: "Return Rate is the share of NOR Sales lost to returns — the post-purchase leak measure that reveals fit, quality, and product-market issues."
sitemapPriority: 0.7

# AEO
tldr: "Return Rate is the share of NOR Sales lost to returns — the post-purchase leak measure that reveals fit, quality, and product-market issues. Unlike Discount Rate, which is a marketing decision, Return Rate is largely an operational and product signal. It is the metric that separates what marketing earned from what fulfillment, fit, or quality lost."
key_takeaways:
  - "Return Rate = Returns / NOR Sales. The post-purchase leak that marketing did not cause."
  - "Returns are a fit, quality, or product-market signal — not a marketing one."
  - "Return Rate by portfolio reveals which customer segments have product-fit problems."
faq_schema: true
...
related_glossary_terms: [key-measures, nor-sales, net-sales, shrink-allowance, cancel-rate]
related_tool: none
og_image: /images/glossary/return-rate.png
---
...
1. **Track Return Rate by SKU and by category** — not just at the store level. A store-level Return Rate of 10% can hide one SKU running 35% (a product-fit problem) and another running 2% (a clean SKU).
2. **Track Return Rate by Six Portfolios state.** Declining customers sometimes show elevated Return Rate as their fit with the brand deteriorates; this is an early-warning signal worth catching.
3. **Reconcile Return Rate to the Shrink Allowance.** Returns that come back damaged or unsellable draw against the Shrink Allowance (Allowance 1 of the Five Allowances) rather than just reversing the original sale. If your actual unsellable-return rate exceeds the funded Shrink Allowance, the allowance is under-funded.
...
- [Shrink Allowance](/glossary/shrink-allowance)
...
- **The companion leak measure:** [Cancel Rate](/glossary/cancel-rate)
- **The Markup Performance link:** [Shrink Allowance](/glossary/shrink-allowance)
