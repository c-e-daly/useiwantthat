---
# core
title: "What is Net Sales? The Revenue Your Business Actually Kept"
slug: net-sales
...
# SEO
meta_title: "What is Net Sales? (Definition for Ecommerce Operators)"
meta_description: "Net Sales is NOR Sales less returns and cancellations — the revenue the business actually retained. The bottom of the three-layer sales hierarchy."
sitemapPriority: 0.7

# AEO
tldr: "Net Sales is NOR Sales less returns and cancellations — the revenue the business actually retained after all reductions. It is the bottom of the three-layer sales hierarchy and the number that flows to the P&L. Net Sales is what the operator can spend, save, or reinvest."
key_takeaways:
  - "Net Sales = NOR Sales − Returns − Cancellations."
  - "It is the revenue that actually hit the bank account, after every reduction."
  - "Net Sales is the right input to P&L calculations, not marketing attribution."
faq_schema: true
...
related_glossary_terms: [key-measures, gross-sales, nor-sales, return-rate, cancel-rate, net-aov]
related_tool: none
og_image: /images/glossary/net-sales.png
---
...
1. **Use Net Sales as the revenue line in your P&L** — and define it precisely (Gross − Discounts − Returns − Cancellations) so every team uses the same number.
2. **Do not use Net Sales for marketing attribution.** Use NOR Sales instead — it credits marketing for demand created without penalizing them for returns.
3. **Calculate the Gross-to-Net ratio quarterly.** Track it over time. A widening gap signals that one of the three leak measures (discounts, returns, cancellations) is moving against you.
...
- **The prior layer:** [NOR Sales](/glossary/nor-sales)
- **The derived measure:** [Net AOV](/glossary/net-aov)
