---
# core
title: "What is NOR Sales? Net of Returns Definition for Ecommerce"
slug: nor-sales
...
# AEO
tldr: "NOR Sales (Net of Returns) is Gross Sales less discounts, but before returns and cancellations. It is the middle layer of the three-layer sales hierarchy and the cleanest measure of marketing performance — because marketing drives the discounted purchase decision but does not cause returns. NOR Sales isolates what marketing earned from what fulfillment or product fit lost."
key_takeaways:
  - "NOR Sales = Gross Sales − Discounts, before returns and cancellations."
  - "It is the cleanest measure of marketing performance — separating what marketing earned from what returns lost."
  - "Often confused with Net Sales; the two are not interchangeable."
faq_schema: true
...
related_glossary_terms: [key-measures, gross-sales, net-sales, discount-rate, average-settle-price]
related_tool: none
og_image: /images/glossary/nor-sales.png
---
...
1. **Use NOR Sales — not Net Sales — for marketing attribution.** It separates what marketing earned from what returns lost.
2. **Calculate Average Settle Price from NOR Sales.** This reveals what customers actually paid after discounts; AUR alone does not.
3. **Track the NOR-to-Net gap monthly.** A growing gap signals a returns or cancellation problem that the headline Net Sales figure may not surface clearly.
...
- **The prior layer:** [Gross Sales](/glossary/gross-sales)
- **The next layer:** [Net Sales](/glossary/net-sales)
