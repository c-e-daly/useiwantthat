---
# core
title: "What is Net AOV? The AOV That Flows to the P&L"
slug: net-aov
...
# SEO
meta_title: "What is Net AOV? (Net Average Order Value Definition)"
meta_description: "Net AOV is Net Sales divided by orders — the AOV that actually flows to the P&L. The only AOV measure that survives discounts, returns, and cancellations."
sitemapPriority: 0.7

# AEO
tldr: "Net AOV is Net Sales divided by total orders in the period — the average order value calculated after discounts, returns, and cancellations have been removed. It is the AOV measure that flows to the P&L and the only AOV that survives every reduction in the sales hierarchy. Two related measures (Gross AOV and NOR AOV) exist but answer different questions."
key_takeaways:
  - "Net AOV = Net Sales / Orders. It is the post-reduction AOV that matches the P&L."
  - "Gross AOV and NOR AOV exist as upstream measures and answer different questions."
  - "Net AOV moving without Gross AOV moving signals a leak in discounts, returns, or cancellations."
faq_schema: true
...
related_glossary_terms: [key-measures, net-sales, gross-sales, nor-sales, aur, average-settle-price]
related_tool: none
og_image: /images/glossary/net-aov.png
---
...
- **The input measure:** [Net Sales](/glossary/net-sales)
- **The related measure:** [AUR](/glossary/aur)
