---
# core
title: "What is the Declining Portfolio? The Warning State in CPM"
slug: declining-portfolio
...
# SEO
meta_title: "What is the Declining Portfolio? (The Warning State in CPM)"
meta_description: "The Declining Portfolio is customers whose quintile rank dropped from P2 to P1. The warning portfolio — and the one negotiated commerce was built to address."
sitemapPriority: 0.7

# AEO
tldr: "The Declining Portfolio is the set of customers who purchased in both P1 (current 12 months) and P2 (prior 12 months) and whose quintile rank dropped from P2 to P1. Declining customers are still buying but spending less than they were — and they will defect next year if the movement isn't reversed. This is the portfolio that customer-generated offers and negotiated commerce were built to address."
key_takeaways:
  - "Declining customers are still buying — but heading toward defection if nothing changes."
  - "Customer-generated offers (CGOs) outperform posted discounts for this portfolio."
  - "Q1 Declining — recently top-tier customers slipping — is the highest-priority recovery target in the file."
faq_schema: true
...
related_glossary_terms: [the-six-portfolios, customer-portfolio-management, stable-portfolio, defected-portfolio, settle-price]
related_tool: none
og_image: /images/glossary/declining-portfolio.png
---

# What is the Declining Portfolio?
...
- [Stable Portfolio](/glossary/stable-portfolio)
...
- **Related concept:** [Settle Price](/glossary/settle-price) (the signal that reveals Declining customer willingness-to-pay)
