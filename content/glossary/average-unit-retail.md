---
# core
title: "What is AUR? Average Unit Retail Definition"
slug: aur
...
# SEO
meta_title: "What is AUR (Average Unit Retail)? Definition for Ecommerce"
meta_description: "AUR is the average selling price per unit across the file at posted prices — Gross Sales divided by gross items sold. The cleanest measure of pricing strategy."
sitemapPriority: 0.7

# AEO
tldr: "AUR (Average Unit Retail) is Gross Sales divided by gross items sold — the average selling price per item across the file at posted prices, before any discounts. It is the cleanest measure of pricing strategy because it isolates the operator's posted-price decisions from the promotional behavior that affects realized prices."
key_takeaways:
  - "AUR = Gross Sales / gross items. It is the posted-price average."
  - "It measures pricing strategy, not realized revenue."
  - "Distinct from Average Settle Price, which is the post-discount realized price."
faq_schema: true
...
related_glossary_terms: [key-measures, gross-sales, average-settle-price, net-aov]
related_tool: none
og_image: /images/glossary/aur.png
---
...
1. **Track AUR monthly** and watch for unintended drift. AUR is supposed to reflect deliberate pricing decisions; if it's moving without an explicit pricing action, the product mix is shifting in a way worth understanding.
2. **Use AUR for category and SKU-level diagnostics.** AUR at the category level reveals which categories are price-strong (high AUR) versus price-weak (low AUR) in your assortment.
3. **Compare AUR to Average Settle Price.** The gap is your effective discount rate at the item level — and a more honest measure than the line-item Discount Rate calculation.
...
- **The realized-price measure:** [Average Settle Price](/glossary/average-settle-price)
- **The input measure:** [Gross Sales](/glossary/gross-sales)
