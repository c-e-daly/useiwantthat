---
slug: "goffman-percent-off-offer"
version: 1
...
featured: false
seo:
  primaryKeyword: "why percent off discounts train customers"
  secondaryKeywords:
    - "consumer frame of reference pricing"
    - "customer generated offers vs discounts"
...
:::summary
- **A discount is a lesson, not an event.** The customer keeps the frame you taught them long after the sale ends.
- **Goffman's keying explains the pricing trap.** The same price reads as fair or unfair depending on what a customer has been taught to expect.
- **Customer generated offers ask instead of impose.** They surface the customer's frame without manufacturing a new discount baseline for the whole file.
:::

:::cta
title: Meet the customer's frame without resetting it
href: /tools/price-builder
label: Run the Price Builder
See how allowance-based pricing lets offers flex without retraining your whole customer file.
:::
