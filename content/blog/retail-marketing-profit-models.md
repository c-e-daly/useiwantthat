---
slug: "retail-marketing-profit-models"
version: 1
...
featured: false
seo:
  primaryKeyword: "retail marketing profit models"
  secondaryKeywords:
    - "clearance profit model retail"
    - "customer acquisition cost NPV"
...
aeo:
  tldr: "There are three retail marketing profit models, not one, because profitable means something different depending on campaign goal. The Standard model measures net profit and EBITDA. The Clearance model measures cash recovered against the opportunity cost of factoring unsold inventory. The Acquisition and Reactivation model measures net present value of future customer lifetime value, not a single period's margin."
  h2DirectAnswers: []
  faq: []
  keyTakeaways:
    - "A clearance campaign that looks unprofitable is often still the right call. The real comparison is against factoring, not against profit."
    - "Acquisition should be judged on NPV of lifetime value, not first-purchase margin."
    - "The same accounting sequence applies to all three models. What changes is which line you are optimizing for."
  definedTerms: []
  validation:
    hasTldr: true
...
1. Identify which model a campaign actually belongs to before you set a success metric. Do not default every campaign to Standard.
2. Apply the correct metric: net profit or EBITDA for Standard, cash recovered versus factoring value for Clearance, NPV of lifetime value versus acquisition cost for Acquisition and Reactivation.
3. Set customer generated offer and counter-offer thresholds against the model's actual metric, not a blanket margin percentage applied across every campaign type.
...
:::summary
- **Clearance succeeds against factoring, not profit.** Those are different questions.
- **Acquisition succeeds against NPV of lifetime value, not first-purchase margin.** The time horizon changes the answer.
- **Picking the wrong model produces the wrong decision.** It leads to over-discounting or under-investing for the wrong reasons.
:::

:::cta
title: Pick the right model before funding the offer
href: /tools/price-builder
label: Run the Price Builder
Use Price Builder to see which profit model applies before you set offer thresholds.
:::
